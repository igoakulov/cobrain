...
def get_backups_dir() -> Path:
    return get_vault_dir() / "backups"


def get_diffs_dir() -> Path:
    return get_vault_dir() / "diffs"


def get_vault_graph_path() -> Path:
    return get_vault_dir() / "vault.yaml"


def get_categories_path() -> Path:
    return get_vault_dir() / "categories.yaml"
...
def get_chats_logs_dir() -> Path:
    return get_vault_dir() / "logs" / "chatgpt"
